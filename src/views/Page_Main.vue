<template>
	...
	<div id="NeverLand-top" class="nl-top-position">
		<div class="nl-top">
			<div class="dia-logo">
				<img class="top-logo" src="../assets/dmyimage/rogo_dmy.png">
			</div>
	...
	<!-- ↑ 現在作成中部分 ↑ -->
	<section id="Illust" class="section-2">
	...
	<!--il背景部分のモーダル-->
	<div id="Top-il" class="tp-il-bg column-center">
		<img class="tp-il-img" src="https://3.bp.blogspot.com/-joXYE8YRH-w/VwIjIGpt9-I/AAAAAAAA5fM/jHtT9Wiwdtgas3DI6gSgxnb19CLZ4_gAw/w1200-h630-p-k-no-nu/internet_offline_offkai.png">
		<div class="tp-il-text m-top-1rem p-tb-05rem p-rl-2rem">
	...
	<section id="Profile-main" class="section">
		...
		<div class="pm-flame center">
			...
			<div id="twitter-color" class="p-twitter-box pm-tw">
				<a class="twitter-timeline" data-width="100%" data-height="100%" data-theme="light" data-chrome=”noheader,transparent,nofooter,noborders,noscrollbar” href="https://twitter.com/TwitterDev?ref_src=twsrc%5Etfw">Tweets by TwitterDev</a> <!--<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>-->
			</div>
		</div>
	</section>
	<div class="dmy"></div>
...
.pm-flame {
	width: 50vw;
	height: 29.48vw;
	background-image: url(../../src/assets/img/profile_flame.svg);
	display: grid;
